...
$text="";
$b_have_info=false;
$wa_form0= waRetrievePostParameter('field_0_wa_id_343cwo7mla9p0wl');
$text.= "Nom\n".$wa_form0."\n\n";
if (($b_have_info==false) && (strlen($wa_form0)>0)) $b_have_info=true;
$wa_form1= waRetrievePostParameter('field_1_wa_id_343cwo7mla9p0wl');
$text.= "Prénom\n".$wa_form1."\n\n";
if (($b_have_info==false) && (strlen($wa_form1)>0)) $b_have_info=true;
$wa_form2= waRetrievePostParameter('field_2_wa_id_343cwo7mla9p0wl');
$text.= "Adresse email\n".$wa_form2."\n\n";
if (($b_have_info==false) && (strlen($wa_form2)>0)) $b_have_info=true;
$wa_form3= waRetrievePostParameter('field_3_wa_id_343cwo7mla9p0wl');
$text.= "Votre téléphone\n".$wa_form3."\n\n";
if (($b_have_info==false) && (strlen($wa_form3)>0)) $b_have_info=true;
$wa_form4= waRetrievePostParameter('field_4_wa_id_343cwo7mla9p0wl');
$text.= "\n\n";
$wa_form5= waRetrievePostParameter('field_5_wa_id_343cwo7mla9p0wl');
$text.= $wa_form5."\n\n";
